...
BeginDialog client_contact_dialog, 0, 0, 311, 125, " MHC client contact"
  ...
  EditBox 65, 55, 240, 15, actions_taken
  CheckBox 65, 80, 160, 10, "Check if worker sent manual enrollment form.", Check_send_enrollment
  EditBox 125, 100, 70, 15, worker_signature
  ButtonGroup ButtonPressed
    OkButton 200, 100, 50, 15
    CancelButton 255, 100, 50, 15
  Text 10, 40, 55, 10, "Reason for call: "
  Text 10, 15, 50, 10, "Case Number:"
  Text 55, 105, 65, 10, "Worker's Signature:"
  Text 210, 15, 40, 10, "Date of call:"
  Text 125, 15, 15, 10, "PMI:"
  Text 10, 60, 50, 10, "Actions taken:"
EndDialog
