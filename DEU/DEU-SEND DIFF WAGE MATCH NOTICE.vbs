'GATHERING STATS===========================================================================================
name_of_script = "DAIL-SEND DIFF WAGE MATCH NOTICE.vbs"
start_time = timer
STATS_counter = 1
...
Else
    ...
    Do 
        ...
        Do
	    	...
	    	END IF
	    Loop until row = 17
    	If row = 17 then script_end_procedure("Could not find pending WAGE match that requires a difference notice sent. Please review the case, and try again.")
    	...
    	Else 
			...
			row = row + 1
			'msgbox sent_notice
    	 	'script_end_procedure("Difference Notice has previously been sent, please clear IEVS match.")
    	END IF 	
