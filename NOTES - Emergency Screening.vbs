...
BeginDialog emergency_screening_dialog, 0, 0, 286, 255, "Emergency Screening dialog"
  ...
  Text 15, 210, 260, 20, "Snappy text to be added by Lee to help HSR's answer the questions about living situation and net income."
  ...
  GroupBox 5, 195, 275, 50, "Info about net income/affordability:"
...
If crisis <> "no crisis given" AND affordbable_housing = "Affordable" AND meets_residency = "Yes" AND  _ 
abs(net_income) < abs(monthly_standard) AND net_income <> "0" AND EMER_last_used_dates = "n/a" then
