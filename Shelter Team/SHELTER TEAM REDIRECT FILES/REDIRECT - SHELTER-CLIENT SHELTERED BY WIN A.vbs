...
'LOADING SCRIPT
url = "https://raw.githubusercontent.com/IlseFerris/Hennepin/master/Shelter%20Team/SHELTER-CLIENT%20SHELTERED%20BY%20WIN%20A.vbs"
...
ELSE														'Error message, tells user to try to reach github.com, otherwise instructs to contact The BlueZone script team withdetails (and stops script).
