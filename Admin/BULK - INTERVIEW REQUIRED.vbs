...
STATS_manualtime = 	66			 'manual run time in seconds
...
'DIALOG----------------------------------------------------------------------------------------------------
BeginDialog appointment_required_dialog, 0, 0, 286, 95, "Appointment required dialog"
  DropListBox 70, 10, 60, 15, "REPT/REVS"+chr(9)+"REPT/REVW", REPT_panel
  ComboBox 185, 10, 95, 15, "Current month"+chr(9)+"Current month plus one"+chr(9)+"Current month plus two", footer_selection
  EditBox 70, 30, 210, 15, worker_number
  CheckBox 5, 65, 155, 10, "Select all active workers in the agency", all_workers_check
  CheckBox 5, 80, 125, 10, "Add client phone number(s) to list", add_phone_numbers_check
  ButtonGroup ButtonPressed
    OkButton 175, 75, 50, 15
    CancelButton 230, 75, 50, 15
  Text 5, 15, 55, 10, "Create list from:"
  Text 140, 15, 45, 10, "Time period:"
  Text 5, 50, 275, 10, "Enter the fulll 7-digit worker number, separate each with a comma if more than one."
