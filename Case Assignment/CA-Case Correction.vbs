...
CALL write_variable_in_CASE_NOTE("~ Case Correction rec'vd via " & app_type & " on " & date_of_app & " ~")
...
IF Send_email = true then
	...
	'CALL create_outlook_email("Ilse.Ferris@hennepin.us;", "mikayla.handley@hennepin.us;", maxis_case_number & " Expedited case to be assigned EOM.", "", "", TRUE)	
End if 
